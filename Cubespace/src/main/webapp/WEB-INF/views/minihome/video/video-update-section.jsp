...
<div class="album-main">
    ...
    <form id="writeVideoForm" action="/videoWrite" method="POST" encType="">
        ...
        <div class="input-row">
            ...
            <input id="videoTitle" name="videoTitle" type="text" placeholder="제목을 입력하세요" value="${video.videoTitle}">
        </div>
        <div class="input-row">
            <label for="videoContent">내용</label>
            <textarea name="videoContent" id="videoContent" rows="6" placeholder="내용을 입력하세요">${video.videoContent}</textarea>
        </div>
        ...
        <div class="input-row">
            ...
            <div id="addVideoArea">
                <video src="${video.videoPath}" id="myVideo"></video>
            </div>
        </div>
