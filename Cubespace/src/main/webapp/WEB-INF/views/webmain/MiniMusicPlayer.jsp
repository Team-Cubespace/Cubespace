                ...
                <div class="player">
                    <div class="player__top">
                        ...
                        <div class="player-controls">
                            <%-- 상품보유 여부 --%>
                            <%-- <div class="plyer-goods-holding player-controls__item -favorite" :class="{ active : currentTrack.favorited }" @click="favorite"> --%>
                            <div class="plyer-goods-holding -favorite" :class="{ active : currentTrack.favorited }">
                                <svg class="icon">
