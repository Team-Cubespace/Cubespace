...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/minihome/video/video-write.css">
...
<body>
    <div class="content-area frame-color">
        ...
        <section class="minihome-rayout">
            <jsp:include page="/WEB-INF/views/minihome/video/video-update-section.jsp"/>
...
<script src="/resources/js/minihome/video/video-update.js"></script>
</html>