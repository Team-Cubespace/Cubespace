...
function addEvent(){
 ...
 document.getElementById("updateBtn").addEventListener("click",function(){
  alert("수정..?");
   //1. 카테고리
   arg.event.extendedProps.category = document.getElementById("category").value;
  //2. 제목
  arg.event.title = document.getElementById("title").value;
  //3. 내용
  if(document.getElementById("description").value = ""){
    arg.event.extendedProps.description = undefined;
  } else {
    arg.event.extendedProps.description = document.getElementById("description").value;
  }
  //4. 시작 날짜
  arg.event.start = document.getElementById("startDate").value+"T"+document.getElementById("startTime").value+":00"
  //6. 종료 날짜
  arg.event.end = document.getElementById("endDate").value+"T"+document.getElementById("endTime").value+":00"
  //7. 종료 시간
  //8. 종일 여부
